...
notebooks_url = "https://github.com/StatBiomed/CamoTSS/raw/main/notebook/"
notebooks = [
    "runBRIE.ipynb"
]
for nb in notebooks:
...
project = "CamoTSS"
author = "Ruiyan Hou"
title = "Cap- and motif- based TSS modelling from 5' scRNA-seq"
...
latex_documents = [
  ('index', 'CamoTSS.tex', u'CamoTSS Documentation',
   u'Ruiyan Hou', 'manual'),
]
...
man_pages = [
    ('index', 'CamoTSS', u'CamoTSS Documentation',
     [u'Ruiyan Hou'], 1)
]
...
texinfo_documents = [
  ('index', 'CamoTSS', u'CamoTSS Documentation',
   u'Ruiyan Hou', 'CamoTSS', 'One line description of project.',
   'Miscellaneous'),
]
